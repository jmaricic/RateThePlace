...
import com.example.josip.ratetheplace.ui.map.allHotels.HotelDetailsMapActivity;
 ...
 */
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> implements ChildEventListener {
    ...
    public CustomAdapter(Context context, Firebase hotelRef) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(this.ctx, HotelDetailsMapActivity.class);
